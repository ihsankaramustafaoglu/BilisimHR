...
namespace bilisimHR.Generator
{
    public static class Models
    {
        ...
        private static string ParentFolder { get { return "Models"; } }
...
AND OWNER = :P_OWNER", hata, CommandType.Text);
        ...
        private static DataTable GetColumns(string TableName)
        {
            ...
            DataTable dt = cmdBLSM.getDataTable("SELECT * FROM ALL_TAB_COLUMNS WHERE OWNER = :P_OWNER AND TABLE_NAME = :P_TABLE AND COLUMN_NAME NOT IN ('ID', 'INSERTED_BY', 'INSERTED_DATE', 'UPDATED_BY', 'UPDATED_DATE')", hata, CommandType.Text);
