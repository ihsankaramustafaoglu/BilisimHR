...
namespace bilisimHR.Infrastructure.Logger.NLog
{
    ...
    //{
    //    //public WebTracer(string configurationFile)
    //    //{
    ...
    //        LogManager.Configuration = new XmlLoggingConfiguration(assemblyFolderTrace, true);
    //    }
    ...
    //        {
    //            if (traceAction != null && traceAction.Target != null && dictionary.Count() > 0)
    //            {
